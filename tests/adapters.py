...
def run_compute_entropy(logits: torch.Tensor) -> torch.Tensor:
    ...
    from cs336_alignment.utils.utils import compute_entropy
...
def run_get_response_log_probs(
    ...
    """
    from cs336_alignment.utils.utils import get_response_log_probs
...
def run_compute_naive_policy_gradient_loss(
    ...
    """
    from cs336_alignment.utils.grpo_utils import compute_naive_policy_gradient_loss
...
def run_compute_grpo_clip_loss(
    ...
    """
    from cs336_alignment.utils.grpo_utils import compute_grpo_clip_loss
...
def run_compute_policy_gradient_loss(
    ...
    """
    from cs336_alignment.utils.grpo_utils import compute_policy_gradient_loss
...
def run_masked_mean(tensor: torch.Tensor, mask: torch.Tensor, dim: int | None = None) -> torch.Tensor:
    ...
    """
    from cs336_alignment.utils.grpo_utils import masked_mean
...
def run_sft_microbatch_train_step(
    ...
    """
    from cs336_alignment.utils.utils import sft_microbatch_train_step
