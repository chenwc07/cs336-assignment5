...
def main(cfg: DictConfig):
    ...
    # ========== Training Loop ==========
    for step in tqdm(range(1, cfg.train.total_steps+1), desc="Training"):
        loss_accum = 0.0
        entropy_accum = 0.0
        ...
        # ========== Checkpointing ==========
        if step % cfg.checkpoint.save_interval_steps == 0:
